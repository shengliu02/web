    ...
    render(){
        ...
        <div className="App-main">
            <div className="container-fluid">
                ...
                <div className="container-fluid-self about-bg">
                ...
                <div className="div-row">
                    ...
                    <div className="div-columndiv-experience">
                        ...
                        <div className="div-right">
                            ...
                            <p>
                                Work in a group size of over 8 Data Analysts. Constantly coorperate with leadership<br/>
                                team to analyst over 80 mentors log data, and generate useful report by using statistical<br/>
                                method. Help mentees to increase self-confidence and self-esteem by envolving <br/>
                            ...
                            <p>
                                Instruct middle school students on basic math and algorithm behind coding. One-to-group<br/>
                                tutoring methology in HTML, CSS, Scratch, and Codester.com challenges. Cooperate host<br/>
                                teacher to analyst and discuss each student's academic performance, and suggestions to<br/>
                                create lesson plan.
            ...
            <div className="container-fluid-self contact-bg" id="contact">
                ...
                <div className="content">
                    <h2 className="margin">Aspiring to become a Software Engineer.</h2>
